...
import BangSanPhamStyle from './BangSanPham.styled';
import BangLocSanPhamStyle from './BangLocSanPham.styled';
import {
  Row,
  Col,
  Image,
...
import HeaderStyle from '../Trang_Chu/Header-JM/container.styled';
...
const DanhMucSanPham = (dbPhones) => {
  const [products, setProducts] = useState(dbPhones.data);
            ...
            <BangSanPhamStyle>
              ...
              <Row>
                <div className="banner_product">
                  <Image className="img_banner_bg" preview={false} />
