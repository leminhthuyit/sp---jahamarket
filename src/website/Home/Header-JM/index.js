...
import gallery4 from "../../../images/gallery/gal-4.jpg";
...
const items = [
  getItem(
    <Link to="/dienthoai">Điện Thoại</Link>,
    "sub1",
    <AiOutlineMobile />,
    [
  ...
  getItem(
    <Link to="/smartwatch">Smart Watchs</Link>,
    "sub4",
    <BsSmartwatch />,
    [
            ...
            <div className="container_menu">
              ...
              >
                ...
                >
                  ...
                  />
                  <Image src={gallery4} style={{ borderRadius: "10px" }} />
                </Space>
              </Drawer>
            </div>
